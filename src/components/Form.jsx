...
const Form = () => {
  return (
    <div>
      ...
      <form className="flex w-full flex-col gap-3" action="https://docs.google.com/forms/d/e/1FAIpQLScy6I-A9f7wvnfO6jBpoORZErqnTB1a6sbJruPkTLWThoa_Sw/formResponse">
        <input
          type="text"
          name= "entry.355332432"
          id="fullname"
